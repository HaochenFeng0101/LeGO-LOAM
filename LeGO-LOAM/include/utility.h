...
extern const string pointCloudTopic = "/publisher/rayz_points";
extern const string imuTopic = "/imu/data";

// Save pcd
extern const string fileDirectory =
    "/home/rayz2004/catkin_ws/dataset/saved_map";
...
extern const bool useCloudRing =
    true; // if true, ang_res_y and ang_bottom are not used

// rayz
extern const int N_SCAN = 128;
extern const int Horizon_SCAN = 1200;
extern const float ang_res_x = 0.08;
...
extern const float surroundingKeyframeSearchRadius =
    50.0; // key frame that is within n meters from current pose will be
          // considerd for scan-to-map optimization (when loop closure disabled)
